odoo.define('axa_theme.AppSwitcher', function (require) {
"use strict";
        ...
        visit(menu_data, function (menu_item, parents) {
            ...
            if (!menu_item.parent_id) {
                if (menu_item.web_icon_data) {
                    ...
                    item.web_icon_data = '/axa_theme/static/src/img/default_icon_app.png';
                }
            } else {
...
odoo.define('axa_theme.ExpirationPanel', function (require) {
"use strict";

var core = require('web.core');
var session = require('web.session');
var utils = require('web.utils');
var AppSwitcher = require('axa_theme.AppSwitcher');
